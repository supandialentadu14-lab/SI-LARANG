...
@section('subheader', 'Edit data berita acara opname')
...
@section('content')
    ...
    <form method="POST" action="{{ route('reports.opname.report') }}" x-data="opnameForm()" x-init="$nextTick(() => updatePembuka())" class="bg-white rounded-lg shadow p-6 space-y-6">
        ...
        <div class="flex items-center justify-end gap-2 pt-2">
            <button type="submit" formaction="{{ route('reports.opname.save') }}" formmethod="POST" class="btn btn-success text-white">
